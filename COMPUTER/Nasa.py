...
def NasaNews(Date):
    ...
    Path_1 = "D:\\COMPUTER\\" + str(FileName)

    Path_2 = "D:\\COMPUTER\\DataBase\\NasaDataBase\\" + str(FileName)
...
def Summary(Boby):
    ...
    path = "D:\\COMPUTER\\DataBase\\NasaDataBase\\Images Used\\" + str(value) + ".jpg"
...
def MarsImage():
    ...
    try:
        ...
        for index , photo in enumerate(Photos):
            ...
            Path_1 = "D:\\COMPUTER\\" + str(img)

            Path_2 = "D:\\COMPUTER\\DataBase\\NasaDataBase\\MarsImage\\" + str(img)
        ...
        Speak("There IS An Error! TRY TO FIX")
